...
Python scripts, operated in natural language via Claude agent skills, replacing what would otherwise be a multi-person finance ops team. The code lives in a private repo ([elixir-ops-automation](https://github.com/anant1597/elixir-ops-automation)) — happy to share access.
